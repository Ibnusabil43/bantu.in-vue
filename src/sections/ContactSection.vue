<template>
  <section class="py-24 section-white">
    <div class="container-custom">
      <div ref="contentRef" class="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
        <!-- Contact Information -->
        <div>
              ...
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <a
                    ...
                    class="text-black hover:text-gray-700 transition-colors inline-flex items-center font-semibold"
                  >
            ...
            <Card class="group">
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-gray-700 mb-3">Kirim email untuk pertanyaan lebih detail</p>
                  <a
          ...
          <div class="p-6 bg-gray-50 border border-gray-200 rounded-lg">
            <h4 class="font-bold text-black mb-2">Jam Operasional</h4>
            <p class="text-gray-700 text-sm">Senin - Jumat: 09:00 - 18:00 WIB</p>
            <p class="text-gray-700 text-sm">Sabtu: 09:00 - 15:00 WIB</p>
            <p class="text-gray-700 text-sm mt-2 italic">*Respon email dalam 1x24 jam</p>
          </div>
        </div>
        ...
        <div>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            <div>
              <label for="name" class="block text-sm font-semibold text-black mb-2">Nama Lengkap</label>
              <input
                id="name"
            ...
            <div>
              <label for="subject" class="block text-sm font-semibold text-black mb-2">Subjek</label>
              <input
                id="subject"
            ...
            <div>
              <label for="message" class="block text-sm font-semibold text-black mb-2">Pesan</label>
              <textarea
                id="message"
...
useScrollReveal(contentRef, { animationClass: 'animate-fade-in-up' })
